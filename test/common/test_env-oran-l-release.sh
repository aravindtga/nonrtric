...
#  ============LICENSE_END=================================================
#
#Profile for ORAN L release
TEST_ENV_PROFILE="ORAN-L-RELEASE"
FLAVOUR="ORAN"
...
A1PMS_IMAGE_TAG_LOCAL="2.10.1-SNAPSHOT"
A1PMS_IMAGE_TAG_REMOTE_SNAPSHOT="2.10.1-SNAPSHOT"
A1PMS_IMAGE_TAG_REMOTE="2.10.0"
A1PMS_IMAGE_TAG_REMOTE_RELEASE="2.10.0"
...
RIC_SIM_IMAGE_TAG_REMOTE_SNAPSHOT="2.8.1-SNAPSHOT"
RIC_SIM_IMAGE_TAG_REMOTE="2.8.1"
RIC_SIM_IMAGE_TAG_REMOTE_RELEASE="2.8.1"

# ORAN Near RT RIC Simulator image and tags
RICMEDIATOR_SIM_IMAGE_BASE="o-ran-sc/ric-plt-a1"
RICMEDIATOR_SIM_IMAGE_TAG_REMOTE_RELEASE_ORAN="3.2.2"

# ORAN Near RT RIC Simulator DB image and tags
RICMEDIATOR_SIM_DB_IMAGE_BASE="o-ran-sc/ric-plt-dbaas"
RICMEDIATOR_SIM_DB_IMAGE_TAG_REMOTE_RELEASE_ORAN="0.6.4"
...
DMAAP_ADP_IMAGE_TAG_LOCAL="1.5.0-SNAPSHOT"
DMAAP_ADP_IMAGE_TAG_REMOTE_SNAPSHOT="1.5.0-SNAPSHOT"
...
AUTHSIDECAR_IMAGE_TAG_LOCAL="1.1.2-SNAPSHOT"
AUTHSIDECAR_IMAGE_TAG_REMOTE_SNAPSHOT="1.1.2-SNAPSHOT"
AUTHSIDECAR_IMAGE_TAG_REMOTE="1.1.2"
AUTHSIDECAR_IMAGE_TAG_REMOTE_RELEASE="1.1.2"
